...
--
-- Host: localhost:3306
-- Generation Time: Feb 29, 2020 at 09:14 AM
...
CREATE TABLE `commercial_in_main` (
...
CREATE TABLE `comm_inv_conditions` (
...
CREATE TABLE `currency_exchangee` (
...
CREATE TABLE `curr_exchange_main` (
  `tab_auto_id` int(11) NOT NULL,
...
CREATE TABLE `manditaxablepurchase` (
  `fid` int(10) NOT NULL,
...
(26, 3071, '13', '2020-02-29', 'IEC : ABCCS3959G', 'Dt 28/2/2020 Telephonic Talk', 'India', 'NEPAL', 'Road', 'INDIA', 'By Truck', 'DURGAPUR WEST BANGAL', 'N.A.', 'NEPAL', 'By Irrevocable LC 100% at Sight.', '0', 'EX-WORK', 1, 1, 3071, 16, '2019-2020', 'SAN', 'A');
...
CREATE TABLE `proforma_item_bck` (
  `tab_auto_id` int(11) NOT NULL DEFAULT '0',
  `proforma_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `goods_descr` text NOT NULL,
...
CREATE TABLE `proforma_lc_details` (
  `tab_auto_id` int(11) NOT NULL,
...
--
ALTER TABLE `comm_in_items`
  MODIFY `comm_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
