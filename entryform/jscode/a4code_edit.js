...
function getDistrict1(provinceId,id1) {		
 ...
 function hledger111(thelist,icnt,theval) {
...
//  document.form1.valuetaxout.icnt.value = content;
  ...
  document.form1[ "stkname" + icnt ].value  = content;
    ...
    document.form1[ "stkid12" + icnt ].value  = theval;
   ...
   function addRow(tableID,fid)
	...
	//   sel1.options[0] = new Option('Select An Item', '0');
	   ...
	   sel1.setAttribute("onchange", "hledger111("+sel1.id+","+rowCount+"),this.value");
       ...
       element11.type = "text";
		//element2.value = "test";
		element11.size="20"
        element11.name="stkid12"+rowCount;
        cell11.appendChild(element11);
