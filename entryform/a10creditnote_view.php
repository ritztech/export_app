...
function deleterecord(deleteId) {
	...
	window.location='a10creditnote_view.php';
      ...
      <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Credit Note Details</span></h3>   
...
<div class="col-lg-8" style="width:100%">
		...
		$emp=("SELECT `cnid`, `supid`, `fid`, `suppliername`, `billno`, `billvalue`, `claims`, `shortage`, `moisture`, `sand`, `oil`, `kirda`, `labour`, `cashdcond`, `brokerage`, `postage`, `bardanaclaims`, `bankcharges`, `other`, `entrydate` FROM `mandia10` WHERE fid = $fid  order by cnid  desc") or die(mysql_error());
...
<a href="a10creditnote_edit.php?cnid= <?php echo  $show['cnid']?> "> Edit/Full View </a>
</td>

<td><input type='button' name='btnprint' value='Delete' onclick='deleterecord(<?php echo  $show['cnid']?>)'/></td>
