...
<div align="center">
  <h2 align="center"><span style="color:#F17327;">Bill PAyment</span>    </h2>
  <form id="form1" name="form1" method="post" onSubmit="return ValidateForm()" action="a7billspayment_back.php">
  <table width="749" border="1" rules="none" frame="box" cellpadding="6">
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2"><select  onChange="getDistrict(this.value),h456(this,suppliername)"  name="province" id="province" style="width:160px">
	...
	while($query_data = mysql_fetch_array($result_dispMake)){
	 ...
	 ?> 
          ...
          <input id="saudadate"   name = "saudadate"  onchange = "isDate(this.value)"   type = "text"  size="11" required="required" />
        ...
        <tr>
          ...
          <td colspan="2"><input type="text" name="suppliername"  readonly  id = "suppliername" size="45"/></td>
...
<tr>
  ...
  <th>ACCOUNTING LEDGER </th> <th>BRANCH</th><th>CHK NO/DD NO</th> <th> AMOUNT </th>  <th>  BANK CHARGES </th>  <th>  TOTAL </th> <th>  MODE OF PAY </th> <th>  REMARK </th>  </tr>
</table> 
