...
function deleterecord(deleteId) {
	...
	window.location='a8fundreciept_view.php';
      ...
      <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Fund Reciept Details</span></h3>   
...
<div class="col-lg-8" style="width:100%">
		...
		$emp=("SELECT * FROM mandia8  where fid = $fid order by a8id desc") or die(mysql_error());
...
<a href="a8fundreciept_edit.php?a8id= <?php echo  $show['a8id']?> "> Edit/Full View </a>
</td>

<td><input type='button' name='btnprint' value='Delete' onclick='deleterecord(<?php echo  $show['a8id']?>)'/></td>
