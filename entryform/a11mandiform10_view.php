...
function deleterecord(deleteId) {
	...
	window.location='a11mandiform10_view.php';
      ...
      <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Mandi Form 10 Application Details</span></h3>   
...
<div class="col-lg-8" style="width:100%">
		...
		$emp=("SELECT *FROM mandia11  WHERE fid = $fid ORDER BY mfid DESC") or die(mysql_error());
...
<td style="width:200px;"><?php  echo $show['stockopening'];  ?></td>
<td style="width:150px;"> <?php  echo $show['transportername'];  ?></td>
<td style="width:150px;"> <?php  echo $show['truckno'];  ?></td>

<td style="width:201px;padding-left:10px;">
<a href="a11mandiform10_edit.php?mfid= <?php echo  $show['mfid']?> "> Edit/Full View </a>
</td>


<td><input type='button' name='btnprint' value='Delete' onclick='deleterecord(<?php echo  $show['mfid']?>)'/></td>
