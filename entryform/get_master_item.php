...
$result12 = mysql_query("SELECT `fid`, `poid`, `suppliername`, `brokername`, `stockitem`, `moisture`, `dust`, `smallseed`, `splitseed`, `oil`, `quantity`, `denometer`, `bag`, `bagquality`, `modeofsupply` FROM `purchase_order` WHERE poid = $poid");
