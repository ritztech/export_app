...
function deleterecord(deleteId) {
	...
	window.location='a7billspayment_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Bill Payment Details</span></h3>   
   ...
   <div class="row">
    ...
    <a href='abca7.php' align="center">Click here to get Excel  report</a>
...
<div class="col-lg-8" style="width:100%">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr  style="background-color:#22B5C1; color:#FFFFFF;">
                                            ...
                                            <th>Party Name</th>	<th>Sauda Date	</th>  <th>Payment Type</th>
											  <th>Amount</th>
		...
		$emp=("SELECT * FROM mandia7  where fid = $fid order by billid desc") or die(mysql_error());
...
<td style="width:200px;"><?php  echo $show['type'];  ?></td>
<td style="width:150px;"> <?php  echo $show['amount'];  ?></td>
<td style="width:150px;"> <?php  echo $show['bankcharges'];  ?></td>
<td style="width:150px;"> <?php  echo $show['total'];  ?></td>


<td style="width:201px;padding-left:10px;">
<a href="a7billspayment_edit.php?billid= <?php echo  $show['billid']?> "> Edit/Full View </a>
</td>

<td><input type='button' name='btnprint' value='Delete' onclick='deleterecord(<?php echo  $show['billid']?>)'/></td>
