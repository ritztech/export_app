...
function deleterecord(deleteId) {
	...
	window.location='a13gatepassdeposit_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Mandi Gate Pass Deposit Details</span></h3>   
...
<div class="col-lg-8" style="width:100%">
		...
		$emp=("select *  from mandi13  where fid = $fid  order by gpid desc") or die(mysql_error());
...
<td style="width:150px;"> <?php  echo $show['stockitem'];  ?></td>
<td style="width:200px;"><?php  echo $show['inwarddate'];  ?></td>
<td style="width:150px;"> <?php  echo $show['gatepassno'];  ?></td>


<td style="width:201px;padding-left:10px;">
<a href="a13gatepassdeposit_front_e.php?a13refid= <?php echo  $show['gpid']?> "> Edit/Full View </a>
</td>
<td style="width:201px;padding-left:10px;">
<a href="a13gatepassdeposit_edit1.php?a13refid= <?php echo  $show['gpid']?> "> Hindi </a>
</td>


<td><input type='button' name='btnprint' value='Delete' onclick='deleterecord(<?php echo  $show['gpid']?>)'/></td>
