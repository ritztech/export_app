...
function deleterecord(deleteId) {
	...
	window.location='salesorder_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;"><i>SALES ORDER DETAILS</i></span></h3>   
...
<div class="col-lg-8" style="width:100%">
		...
		$emp=("SELECT * FROM mandia5  where fid = $fid order by soid desc") or die(mysql_error());
...
<td style="width:150px;"> <?php  echo $show['rate'];  ?></td>

<td style="width:201px;padding-left:10px;">
<a href="salesorder_edit.php?soid= <?php echo  $show['soid']?> "> Edit/Full View </a>
</td>


<td><input type='button' name='btnprint' value='Delete' onclick='deleterecord(<?php echo  $show['soid']?>)'/></td>
