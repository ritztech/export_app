...
if($fid ==12){$gst_zz = "23AGSPJ1748E1ZF";$fssi_zz = "11417510000009";}
if($fid ==15){$gst_zz = "23AGSPJ1748E1ZF";$fssi_zz = "11417510000009";}
...
`issuesamiti`, `truckno`, `billtyno`, `otherdoc`, `porderno`, `freighttotal`, `freightadv`, `freightpaid`, `weightbridgename`,
 ...
 `vattax1`, `billvalue1`, `ledgername`,ledgername_n,supid,brkid,trid,freight_type,freight_receivable,contractnumber,`gstin`, `gst_0`, `gst_5`, `gst_12`, `gst_18`, `gst_28`,aadhar,billtype,placesupply,shippid FROM `mandia6` WHERE siid=?";
...
<body>
<form id="form1" name="form1" method="post" action="sales_view_ed_bck.php">
...
<tr> <td colspan="1" > <b> PLACE OF SUPPLY: <?php  echo $off_addr1_ss ?></b> </td>  
...
<tr> 
 ...
 <tr> <td align = "left" colspan = "3"  > <b>NO EWAY BILL IS REQUIRED GOODS ARE EXEMPT AS PER RULE 138(14) </b> </td> <td colspan = "4"  align = "right">  Total tax : <?php   echo $all_t_tax; ?>  </td>  </tr>
