...
<th colspan="4"> <table  border="1" width="100%"> 
<tr> <td width="50%">  <table border="1"  width="100%" ><tr><td  width="30%">Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp :  </td>  <td width="70%" align="left" >  <?php if($fid==16){ ?> MRP AGRO PRIVATE LIMITED <?php } ?>  <?php if($fid==19){ ?> MRP AGRO IMPEX <?php } ?>   </td>  </tr> 
...
<?php if($fid==19){ ?> Regd. Off- R1 868, MRP AGRO IMPEX, ABDUL ABBASH KHAN SATTAR KHAN,SUDHASAGAR ROAD, TIKAMGARH State Madhya Pradesh   INDIA GSTN 23CBLPK1195E1ZS IEC CBLPK1195E  <?php } ?>  </td>  </tr>
...
<td width="33%" align="center" valign="top">  <table  width="100%"><tr> <td> Bill No.  </td>  <td>  MRP/2019-2020/00<?php echo $billno;  ?>   </td>  </tr>
...
<tr>  <td colspan="2"> <font size="1"> GST LUT Details : Application Reference Number (ARN) AD2308190011791 dt 19/08/2019 </font>  </td> </tr>
...
<?php echo $trans_name_ss; ?></br></br></br></br>
