...
//ROBERT SORIANO 2015
	...
	$query = "SELECT `uid`, `uname`, `username`, `mobile`, `securitylevel`, `status`, `fname`,DATE_FORMAT(sdate,'%d/%m/%Y') as sdate,DATE_FORMAT(enddate,'%d/%m/%Y') as enddate FROM `appuser`  where fid = $id";
