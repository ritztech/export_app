...
$fid = $_POST['fid'];
  ...
  echo "<script>alert('Data updated Successfully .');location.href='newuser_view.php'</script>";
              ...
              <table width="800" border="0" cellpadding="1">
                <tbody>
                  ...
                  <tr>
                    ...
                    <input id="midate"   name = "midate" onchange = "isDate(this.value)"   type = "text"  size="17"  value="<?php echo $midate; ?>" />  <a href="javascript:NewCal('midate','ddmmyyyy')"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
                  ...
                  Number:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <td>Issue Date:</td>
                    <td><div align="left">
                        <input id="mandidate"   name = "mandidate"  onchange = "isDate(this.value)"  type = "text"  size="17"  value="<?php echo $mandidate; ?>" />  <a href="javascript:NewCal('mandidate','ddmmyyyy')"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></div></td>
                  </tr>
                  <tr>
                    <td>CST Registration
                    Number:&nbsp;</td>
                    ...
                    <td>Issue Date:</td>
                    <td><div align="left">
                     <input id="cstdate"   name = "cstdate"  onchange = "isDate(this.value)"  type = "text"  size="17"  value="<?php echo $cstdate; ?>" />  <a href="javascript:NewCal('cstdate','ddmmyyyy')"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></div></td>
                  </tr>
                ...
                <td>Firm/ROC Registration 
                    ...
                    <td>Issue Date:</td>
                    <td><div align="left">
                     <input id="tindate"   name = "tindate" onchange = "isDate(this.value)"   type = "text"  size="17"  value="<?php echo $tindate; ?>" />  <a href="javascript:NewCal('tindate','ddmmyyyy')"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></div></td>
                  </tr>
                  <tr>
                    <td>FSSAI License
                  Number:&nbsp;</td>
                    ...
                    <td>Issue Date:</td>
                    <td><div align="left">
                      <input id="fdate"   name = "fdate" onchange = "isDate(this.value)"  type = "text"  size="17"  value="<?php echo $fdate; ?>" />  <a href="javascript:NewCal('fdate','ddmmyyyy')"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
                    </div></td>
                  </tr>
                  <tr>
                    <td>Income Tax
                  Number:&nbsp;</td>
                    ...
                    <td>Issue Date:</td>
                    <td><div align="left">
                      <input id="itndate"   name = "itndate" onchange = "isDate(this.value)"  type = "text"  size="17"  value="<?php echo $itndate; ?>" />  <a href="javascript:NewCal('itndate','ddmmyyyy')"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
                    </div></td>
                </tr>
                  <tr>
