...
$result1 = mysql_query("SELECT `val1`, `val2` FROM `condition_master` WHERE `tab_id`=$id");
...
<div>
<p>&nbsp;</p>
  <h2 align="center"><span style="color:#F17327;">EDIT  Condition </span></h2>
  
    
    <form id="form1" name="form1" method="post"  enctype="multipart/form-data"  action="my_condition_back_2_edit.php">
      ...
      <div align="center">
        <table  border="2" rules="none" frame="box" cellpadding="1"  bgcolor="white"  style="font-style:bold;font-weight:bold;"  >
          <tbody>
			  ...
			  <td><input type="text"  size="30" value = "<?php echo $row1['0']; ?>"   name="cond1"  /></td>
			 <td>  <input type="text"  value = "<?php echo $row1['1']; ?>"  size="70" name="detail2"  />
			  </td>
            </tr>
...
<?php  } ?>
	  ...
	  <input  type = "text"  name = "condid"  value = "<?php echo $id  ?>" id = "condid"  /> 
