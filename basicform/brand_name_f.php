...
<script language="javascript" type="text/javascript" src="../entryform/jscode/purchase_items.js"> </script>
...
<div>
<p>&nbsp;</p>
  <h2 align="center"><span style="color:#F17327;">Add Brand items</span></h2>
  
    
    <form id="form1" name="form1" method="post" action="brand_name_b.php">
...
<INPUT type="button" tabindex = "2"  style = "color:red; font-weight:bold;height: 30px; width: 95px; font:"Times New Roman", Times, serif; font-size:14px;" value="ADD ITEM" onClick="addRow('dataTable');" /> 
