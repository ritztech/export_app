...
<div class="col-lg-8"  style="width:100%">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr  style="background-color:#22B5C1; color:#FFFFFF;">
                                            ...
                                            <th>STOCK_ITEM</th>	<th>BRAND NAME</th>  
		...
		$emp=("SELECT `stkid`, `stkname`, `brand_name`, `brand_id`, `fid` FROM `brand_name`   where fid = $fid") or die(mysql_error());
...
<td style="width:150px;"> <?php  echo $show['stkname'];  ?></td>
