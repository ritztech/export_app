...
<div class="col-lg-8"  style="width:100%">
		...
		$emp=("SELECT `tab_auto_id`, `remarks` FROM `curr_exchange_main` ") or die(mysql_error());
...
<a href="exchange_details.php?id= <?php echo  $show['tab_auto_id']?> ">
 <?php  echo $show['remarks'];  ?></a></td>
