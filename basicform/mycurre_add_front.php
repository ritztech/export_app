...
<div>
<p>&nbsp;</p>
  <h2 align="center"><span style="color:#F17327;">Add  Currency </span></h2>
  
    
    <form id="form1" name="form1" method="post"  enctype="multipart/form-data"  action="my_curre_bck.php">
     
      <div align="center">
        <table  border="2" rules="none" frame="box" cellpadding="1"  bgcolor="white"  style="font-style:bold"  >
          <tbody>
            <tr>
              <td width="208"><label for="textfield">Curr Name:</label></td>
