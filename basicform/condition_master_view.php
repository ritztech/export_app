...
function deleterecord(deleteId) {
	...
	window.location='a7billspayment_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Proforma Conditions   Master</span></h3>   
...
<div class="col-lg-8"  style="width:100%">
                            ...
                            <div class="table-responsive" >
							   ...
							   <thead>
							            ...
							            <tr  style="background-color:#22B5C1; color:#FFFFFF;">
										      <th><a href="mycondition_add_front.php" ><button class="dropbtn">ADD NEW</button></a></th>
		...
		$emp=("SELECT `tab_id`, `val1`, `val2` FROM `condition_master`  ") or die(mysql_error());
...
<a href="mycondition_add_front_edit.php?id= <?php echo  $show['tab_id']?> ">
 <?php  echo $show['val1'];  ?></a></td>
 
 <td style="width:450px;"> <?php  echo $show['val2'];  ?> </td>  
