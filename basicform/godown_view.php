...
function deleterecord(deleteId) {
	...
	window.location='a7billspayment_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Godown Master</span></h3>   
...
<div class="col-lg-8"  style="width:100%">
							  ...
							  Add new   
							   ...
							   <thead>
							            ...
							            <tr  style="background-color:#22B5C1; color:#FFFFFF;">
										      <th><a href="god_view.php" ><button class="dropbtn">ADD NEW</button></a></th>
                                        ...
                                        <tr  style="background-color:#22B5C1; color:#FFFFFF;">
                                            ...
                                            <th>Godown name</th>	<th>Contact</th> 	<th>Address</th>  
		...
		$emp=("SELECT `gid`, `gname`, `gcontact`, `gaddress`, `fid` FROM `godown`") or die(mysql_error());
...
<a href="godown_master_front_edit.php?id= <?php echo  $show['gid']?> ">
 <?php  echo $show['gname'];  ?></a></td>
 
 
<td style="width:100px;"> <?php  echo $show['gcontact'];  ?></td>
<td style="width:250px;"> <?php  echo $show['gaddress'];  ?></td>
