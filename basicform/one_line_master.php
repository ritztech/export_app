...
function deleterecord(deleteId) {
	...
	window.location='a7billspayment_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">One Line  Master</span></h3>   
...
<div class="col-lg-8"  style="width:100%">
                            ...
                            <div class="table-responsive" >
							   ...
							   <thead>
							            ...
							            <tr  style="background-color:#22B5C1; color:#FFFFFF;">
										      <th><a href="add_one_line_front.php" ><button class="dropbtn">ADD NEW</button></a></th>
		...
		$emp=("SELECT `id`, `mytext` FROM `oneline`") or die(mysql_error());
...
<a href="my_one_line_edit.php?id= <?php echo  $show['id']?> ">
 <?php  echo $show['mytext'];  ?></a></td>
