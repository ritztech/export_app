...
function deleterecord(deleteId) {
	...
	window.location='a7billspayment_view.php';
     ...
     <h3 align="center" style="background-color:#004D71; margin-top:0px;"><span style="color:#FFFFFF;">Currency  Master</span></h3>   
...
<div class="col-lg-8"  style="width:100%">
							  ...
							  Add new   
							   ...
							   <thead>
							            ...
							            <tr  style="background-color:#22B5C1; color:#FFFFFF;">
										      <th><a href="mycurre_add_front.php" ><button class="dropbtn">ADD NEW</button></a></th>
		...
		$emp=("SELECT `tab_auto_id`, `curr_name` FROM `currency_master`") or die(mysql_error());
...
<a href="my_curr_front_edit.php?id= <?php echo  $show['tab_auto_id']?> ">
 <?php  echo $show['curr_name'];  ?></a></td>
