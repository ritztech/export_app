...
if (isset($_POST['submit'])) {
	...
	//  if (($_FILES["file"]["size"][$i] < 1000000) //Approx. 100kb files can be uploaded.
      //          && in_array($file_extension, $validextensions))
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'][$i], $target_path)) {//if file moved to uploads folder
               ...
               $qry3 = "INSERT INTO upload (uppath,fid,desc1,fname,fyear) VALUES ('$target_path',$fid,'$desc1','$f_ext','$financialyr')";
			  // echo $qry3;
 ...
 echo '<script>window.location="doc_view_all.php"</script>';
