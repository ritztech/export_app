...
<div align="center">
  <h2 align="center"><span style="color:#F17327;">SALES REPORT [RD/URD] REPORT </span>
    <script language="javascript" type="text/javascript" src="../datetimepicker.js"> </script>
</h2>
...
$result14=mysql_query("SELECT partyname,DATE_FORMAT(date,'%d/%m/%Y') as date , sum( bag1 ),sum(grossweight2),sum(mandigatepass1),sum(billweight),sum(rateoftax1),sum(rateofgoods1),sum(value1), sum(vattax1),sum(billvalue1) FROM mandia6 WHERE date between STR_TO_DATE('$st_1','%d/%m/%Y') and STR_TO_DATE('$end_1','%d/%m/%Y') and fid=$fid group by date,partyname");
...
{
$result13 = mysql_query("select a1.partyname,DATE_FORMAT(a1.date,'%d/%m/%Y'),a2.stockid,a2.formid,a2.bag, a2.grswght,a2.mandiwght,a2.billwght,a2.rot,a2.rog,a2.vale,a2.vtou,a2.bilvalue,a2.remark,
 a2.tempid FROM mandia6 a1,stock_ref a2 where a2.formid=a1.siid and date= STR_TO_DATE('$row14[1]','%d/%m/%Y') and a1.partyname='$row14[0]' 
