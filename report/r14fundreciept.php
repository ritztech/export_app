...
<div align="center">
  <h2 align="center"><span style="color:#F17327;"> FUND RECEIPTS REGISTER REPORT </span>
    <script language="javascript" type="text/javascript" src="../datetimepicker.js"> </script>
</h2>
...
FROM mandia8 WHERE saudadate between STR_TO_DATE('$st_1','%d/%m/%Y')  and STR_TO_DATE('$end_1','%d/%m/%Y') and fid=$fid
GROUP BY saudadate");
...
{
$result13 = mysql_query("select a1.suppliername,DATE_FORMAT(a1.saudadate,'%d/%m/%Y'),a2.bankname, a2.formid,a2.branch, a2.chequeno,a2.amount,a2.bankcharges,a2.total, a2.modeofpay,a2.remark,a2.tempid FROM mandia8 a1,mandia7_ref a2 where a2.formid=a1.a8id and a1.saudadate =  STR_TO_DATE('$row14[0]','%d/%m/%Y') and a2.tempid='A8' and a1.fid=$fid ");
